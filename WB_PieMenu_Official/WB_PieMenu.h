...
extern int   g_numpadEnterAction; // 0=no action, 1=open Quick menu, 2=open Wheel menu, 3=open Pie menu, 4=open Infinite menu
extern bool  g_numpadTriggered;   // set true before ShowMenu() when triggered by numpad Enter
